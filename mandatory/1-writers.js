...
function logDeadWritersInTheirForties() {
  let result = writers.filter(
    (isDead) => isDead.age > 40 && isDead.age <= 49 && isDead.alive === false
  );
  console.log(
    `Writer ${result[0].firstName} ${result[0].lastName} died at ${result[0].age} years old.`
  );
}
